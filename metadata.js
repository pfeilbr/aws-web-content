 export default {
    "directories": [
    {
      ...
      "displayMetadata": {
        ...
        "fields":[
          ...
          {"field": "item.additionalFields.publishedDate", "headerName": "Date", "sort": "desc"},
    ...
    },
    {
      ...
      "fields": [
        ...
        {"field": "item.additionalFields.launchDate", "headerName": "Date", "sort": "desc"},
        {"field": "item.tags", "headerName": "Tags"},        
    ...
    },    
    {
      ...
      "displayMetadata": {
        ...
        "fields": [
          {"field": "item.additionalFields.headline", "headerName": "Title", "linkField": "item.additionalFields.headlineUrl"},
          {"field": "item.dateUpdated", "headerName": "Date", "transform": (s) => (s.split("T")[0]), "sort": "desc"},
          {"field": "item.tags", "headerName": "Tags"},
          //{"field": "item.author", "headerName": "Author"},
          // {"field": "item.id"},
          // {"field": "item.name"},
...

    {
      ...
      "fields": [
        ...
        {"field": "item.dateCreated", "headerName": "Date", "transform": (s) => (s.split("T")[0]), "sort": "desc"},
        {"field": "item.tags", "headerName": "Tags"},        
        // {"field": "item.author", "headerName": "Author"},
        // {"field": "item.id"},
        // {"field": "item.name"},
    ...
    },
    {
      ...
      "displayMetadata": {
        ...
        "fields": [
          ...
          {"field": "item.additionalFields.bulletinDate", "headerName": "Date", "sort": "desc"},
          {"field": "item.tags", "headerName": "Tags"},          
          //{"field": "item.author", "headerName": "Author"},
          // {"field": "item.id"},
          // {"field": "item.name"},
